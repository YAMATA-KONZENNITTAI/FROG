...
if __name__ == "__main__":
    ...
    #画像を管理する辞書型
    img = { i[:-4:] : Image.open("../../with_unkochan/" + i) for i in sorted(listdir("../../with_unkochan"))}
    img_tk = { i[:-4:] : ImageTk.PhotoImage(Image.open("../../with_unkochan/" + i)) for i in sorted(listdir("../../with_unkochan"))}
